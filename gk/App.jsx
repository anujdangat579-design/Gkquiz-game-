...
import AdminQuestionBankPdfs from './admin/AdminQuestionBankPdfs.jsx'
import AdminWinnerMessages from './admin/AdminWinnerMessages.jsx'
  ...
  return (
    <Routes>
      ...
      <Route path="/admin" element={<AdminGate />}>
        ...
        <Route path="question-bank-pdfs" element={<AdminQuestionBankPdfs />} />
        <Route path="winner-messages" element={<AdminWinnerMessages />} />
      </Route>
